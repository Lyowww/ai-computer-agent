...
export function buildSystemPrompt(intent?: ClassifiedIntent): string {
  ...
  return [
    ...
    "",
    "OPEN_APP rules:",
    "- The desktop agent can open installed macOS GUI applications by application name.",
    "- For OPEN_APP, provide the exact visible/common application name (e.g. Telegram, Discord, Google Chrome).",
    ...
    "- If the requested application is visible or clearly named, use OPEN_APP.",
    "- Never substitute a different application when the requested one is missing.",
    intentLock,
    "",
